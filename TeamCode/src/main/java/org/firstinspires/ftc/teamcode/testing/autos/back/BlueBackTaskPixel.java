...
public class BlueBackTaskPixel extends LinearOpMode {
            ...
            switch (cv.detector.location){
                case LEFT:
                    pathRandom = new Path(pathRandom.lastPoint)
                            .goTo(new Point(-63,70,110))
                            .goTo(new Point(0,150,270))
                            .goTo(new Point(190,150,270));
                            //.goTo(new Point(-70,45,270));
                    break;
                case MIDDLE:
                    pathRandom = new Path(pathRandom.lastPoint)
                            .goTo(new Point(0,150,270))
                            .goTo(new Point(190,130,270));
                            //.goTo(new Point(0,130,0))
            ...
            switch (cv.detector.location) {
                ...
                case MIDDLE:
                    pathRandom = new Path(pathRandom.lastPoint)
                            ...
                            .goTo(new Point(0,130,0))
                            .goTo(new Point(-40,110))
                            .goTo(new Point(-70,65,270));
                    break;
                case RIGHT:
                    pathRandom = new Path(pathRandom.lastPoint)
                            .goTo(new Point(190,75,325))
                            .goTo(new Point(120,140,270))
                            .goTo(new Point(0,140,200))
